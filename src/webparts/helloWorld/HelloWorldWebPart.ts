...
> {
  // prevent the page reloading on every key stroke
  // add apply button
  protected get disableReactivePropertyChanges(): boolean {
    return true;
  }

  // render the webpart to the page
  public render(): void {
  ...
  // get the data from the Mock SharePoint list
  ...
  // get the list data from "live" SharePoint
  ...
  // render the data from the rest query
  private _renderList(items: ISPList[]): void {
    ...
    // put the data into the right place
  ...
  // detect the environment and either get data
  // from mock list of live list
